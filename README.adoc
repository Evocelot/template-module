...
link:https://hub.docker.com/repository/docker/evocelot/.../general[dockerhub]
...
[source,bash]
----
docker compose -f etc/docker/compose/liquibase/docker.compose.local.modulebase.liquibase.yml up -d
----
...
[source,bash]
----
docker cp modulebase-services/sample-jpa-service/target/sample-jpa-service-<VERSION>-SNAPSHOT.war evocelot-modulebase-service:/home/icellmobilsoft/wildfly/standalone/deployments/ROOT.war
----
